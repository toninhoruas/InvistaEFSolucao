...
namespace InvistaEFSolucao.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(BloggingContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,NomeFantasia,RazaoSocial,CNPJ,InscricaoEstadual,Endereco,Numero,Complemento,Bairro,Cidade,UF,CEP")] Cliente cliente)
        {
